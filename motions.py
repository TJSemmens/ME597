...
from rclpy.qos import HistoryPolicy, DurabilityPolicy, ReliabilityPolicy
import math
...
class motion_executioner(Node):
    ...
    def laser_callback(self, laser_msg: LaserScan):
        ...
        self.laser_logger.log_values([laser_msg.ranges, Time.from_msg(laser_msg.header.stamp).nanoseconds])
