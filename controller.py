...
class controller:
    ...
    def __init__(self, klp=20, klv=0.1, kli=0.01, kap=20, kav=0.01, kai=0.1):
        ...
        self.PID_linear=PID_ctrl(PD, klp, klv, kli, filename_="linear_P_trajectory_2.csv")
        self.PID_angular=PID_ctrl(PD, kap, kav, kai, filename_="angular_P_trajectory_2.csv")
    ...
    def vel_request(self, pose, goal, status):
        ...
        linear_vel = 0.25 if linear_vel > 0.31 else linear_vel
        angular_vel= 1.8 if angular_vel > 1.9 else angular_vel
...
class trajectoryController(controller):
    ...
    def __init__(self, klp=0.2, klv=0.2, kli=0.2, kap=0.5, kav=0.2, kai=0.2, lookAhead=1.0):
    ...
    def vel_request(self, pose, listGoals, status):
        ...
        linear_vel = 0.15 if linear_vel > 0.22 else linear_vel
        angular_vel= 2 if angular_vel > 2.84 else angular_vel
